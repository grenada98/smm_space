document.addEventListener('DOMContentLoaded', function(){
    ...
    //to top
        ...
        if(headerLinks){
            Array.from(headerLinks).forEach(function(el){el.addEventListener("click", function(){
        ...
        if(variablePayOffer){
            Array.from(variablePayOffer).forEach(function(el){el.addEventListener("click", function(){
...
*/
        ...
        if(selectServicesMobile){
         ...
         if(listOfServices){
            Array.from(listOfServices).forEach(function(el){el.addEventListener("click", function(){
        ...
        if(itemsSocialNetwork){
            Array.from(itemsSocialNetwork).forEach(function(el){el.addEventListener("click", function(){
                ...
                if(dataSocial[this.dataset.name].length!=null){
                    for (let i=0; i<dataSocial[this.dataset.name].length; i++){
                        ...
                        console.log(document.querySelector(`.item-service-service-page[data-name="${dataSocial[this.dataset.name][i]}"]`));
        ...
        if(paginationButtonFeedback){
            Array.from(paginationButtonFeedback).forEach(function(el){el.addEventListener("click", function(){
        ...
        if(buttonPanelControl){
            Array.from(buttonPanelControl).forEach(function(el){el.addEventListener("click", function(){
        ...
        if(selectPayUp){
            Array.from(selectPayUp).forEach(function(el){el.addEventListener("click", function(){
        ...
        if(buttonSortOfferHistory){
            Array.from(buttonSortOfferHistory).forEach(function(el){el.addEventListener("click", function(){
        ...
        if(checkboxSettingsFake){
            Array.from(checkboxSettingsFake).forEach(function(el){el.addEventListener("click", function(){
                if(this.classList.contains("active")){
                    this.classList.remove("active");
        ...
        if(selectCountShowReferals){
            Array.from(selectCountShowReferals).forEach(function(el){el.addEventListener("click", function(){
        ...
        if(chatListControlPanel){
            Array.from(chatListControlPanel).forEach(function(el){el.addEventListener("click", function(){
        ...
        if(countNewMessage){
            Array.from(countNewMessage).forEach(function(el){el.addEventListener("DOMSubtreeModified", function(){
